...
let get_workspace_id ?(update=false) ws_name wcs_cred ws_config get_id_fname ws =
  ...
  | Some id ->
      ...
      | true, Some w ->
          Wcs_api_unix.update_workspace wcs_cred id w;
          id
      | _, _ -> id
      end
  | None ->
      ...
      in
      let rsp = Wcs_api_unix.create_workspace wcs_cred workspace in
...
let workspaces_delete wcs_cred =
  ...
  in
  oiter (Wcs_api_unix.delete_workspace wcs_cred) ws_conf.ws_select_example_id;
  oiter (Wcs_api_unix.delete_workspace wcs_cred) ws_conf.ws_select_expr_id;
  oiter (Wcs_api_unix.delete_workspace wcs_cred) ws_conf.ws_dispatch_id;
  oiter (Wcs_api_unix.delete_workspace wcs_cred) ws_conf.ws_when_id;
  oiter (Wcs_api_unix.delete_workspace wcs_cred) ws_conf.ws_cond_id;
  oiter (Wcs_api_unix.delete_workspace wcs_cred) ws_conf.ws_cond_continue_id;
  oiter (Wcs_api_unix.delete_workspace wcs_cred) ws_conf.ws_then_id;
  oiter (Wcs_api_unix.delete_workspace wcs_cred) ws_conf.ws_expr_id;
  oiter (Wcs_api_unix.delete_workspace wcs_cred) ws_conf.ws_actn_id;
  oiter (Wcs_api_unix.delete_workspace wcs_cred) ws_conf.ws_accept_id;
  ()
